...
import { updateSASupplierAction, type SupplierState } from '../../actions';
...
export function EditSupplierForm({ id, defaultValues }: Props) {
  const boundAction = updateSASupplierAction.bind(null, id);
  const [state, action] = useFormState<SupplierState | null, FormData>(boundAction, null);
