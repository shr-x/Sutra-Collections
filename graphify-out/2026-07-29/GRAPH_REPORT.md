# Graph Report - Sutra Collections  (2026-07-28)

## Corpus Check
- 378 files · ~204,142 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1706 nodes · 3833 edges · 135 communities (110 shown, 25 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 332 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7f8b5bbe`
...
1. `requireRole()` - 359 edges
2. `query()` - 345 edges
3. `requireSA()` - 109 edges
4. `formatInr()` - 72 edges
5. `pool` - 54 edges
6. `getSession()` - 52 edges
7. `logAudit()` - 42 edges
8. `ActionResult` - 27 edges
9. `sendWhatsAppTemplate()` - 22 edges
10. `calcInvoiceTotals()` - 21 edges
...
Cohesion: 0.16
Nodes (12): COOKIE_OPTIONS, getSecret(), signSession(), loginAction(), LoginSchema, LoginState, logoutAction(), config (+4 more)

### Community 1 - "Invoice & Search API Routes"
Cohesion: 0.08
Nodes (32): GET(), GET(), GET(), DELETE(), DELETE(), GET(), POST(), DELETE() (+24 more)
...
Cohesion: 0.17
Nodes (11): metadata, metadata, EditWarehousePage(), NewWarehousePage(), activateWarehouseAction(), createWarehouseAction(), deleteWarehouseAction(), updateWarehouseAction() (+3 more)

### Community 5 - "Tailoring Order Flow"
Cohesion: 0.12
Nodes (11): FabricOption, Props, CustomerOption, DesignOption, Field, MeasurementVersion, Props, STEPS (+3 more)

### Community 6 - "Purchase Listing & Search UI"
Cohesion: 0.10
Nodes (18): InvoicesPage(), STATUS_BADGE, metadata, PurchasesPage(), Props, SearchInput(), BADGE, CreditNotesPage() (+10 more)

### Community 7 - "CRM, Designs & Reminders"
Cohesion: 0.07
Nodes (29): metadata, metadata, NewUserPage(), metadata, metadata, metadata, NewSupplierPage(), metadata (+21 more)

### Community 8 - "Project Documentation"
Cohesion: 0.10
Nodes (29): Build Phases (Foundation through Polish), Cloudflare Tunnel (shr-x.in), Docker Compose Containerization, Sutra Collections ERP System, Gemini API (AI Import), GST Tax-Inclusive Pricing Rule, GST Setup (Regular, Monthly GSTR-1+3B, CGST+SGST), Iron-Session Auth (+21 more)
...
Cohesion: 0.07
Nodes (20): POST(), GET(), S, fmtInr(), GET(), S, GET(), EditInvoicePage() (+12 more)

### Community 11 - "Customer Detail & Edit Pages"
Cohesion: 0.22
Nodes (6): EditCustomerPage(), metadata, metadata, NewCustomerPage(), Props, Customer
...
Cohesion: 0.08
Nodes (25): CreditNote, CreditNoteStatus, DebitNote, Design, DesignMeasurementField, DiscountScheme, Invoice, InvoiceItem (+17 more)

### Community 15 - "Inventory & Supplier Import API"
Cohesion: 0.19
Nodes (9): MonthSelector(), Gstr1Page(), InvoiceRow, metadata, Gstr3bPage(), metadata, HsnPage(), HsnRow (+1 more)
...
Cohesion: 0.13
Nodes (12): BestSellersPage(), metadata, DatePicker(), DatePickerProps, DAY_HEADERS, fmtDisplay(), MONTHS, todayIso() (+4 more)
...
Cohesion: 0.32
Nodes (4): EditSupplierPage(), metadata, Props, Supplier
...
Cohesion: 0.16
Nodes (10): MovementState, ItemWithVariants, MOVEMENT_LABELS, Props, metadata, StockPage(), ItemVariant, Warehouse (+2 more)
...
Cohesion: 0.15
Nodes (14): metadata, STATUS_BADGE, STATUS_LABEL, ALL_STATUSES, TailoringOrderDetailPage(), fmt(), PaymentRow, PaymentSection() (+6 more)

### Community 26 - "Module Group 26"
Cohesion: 0.11
Nodes (16): metadata, metadata, EditReminderPage(), NewReminderPage(), createReminderAction(), deleteReminderAction(), ReminderSchema, toggleReminderAction() (+8 more)

### Community 27 - "Module Group 27"
Cohesion: 0.07
Nodes (23): POST(), POST(), metadata, NewInvoicePage(), SchemeSchema, EditSchemePage(), metadata, metadata (+15 more)

### Community 28 - "Module Group 28"
Cohesion: 0.14
Nodes (13): metadata, metadata, metadata, metadata, BillingPage(), metadata, DashboardPage(), metadata (+5 more)

### Community 29 - "Module Group 29"
Cohesion: 0.25
Nodes (6): AttendanceStatus, DAY_NAMES, DayEntry, Props, StaffUser, STATUS_CONFIG

### Community 30 - "Module Group 30"
Cohesion: 0.21
Nodes (6): BusinessFormState, saveBusinessSettingsAction(), INITIAL, Props, INITIAL, Props

### Community 31 - "Module Group 31"
Cohesion: 0.21
Nodes (7): fmtInr(), GET(), S, migrate(), runSqlFile(), pool, AccountTable()

### Community 32 - "Module Group 32"
Cohesion: 0.06
Nodes (25): ConfirmDialog(), ConfirmDialogProps, COLOR_HEX, ItemPickerModalProps, PendingSlot, PickerAddEvent, PickerColor, PickerItem (+17 more)

### Community 33 - "Module Group 33"
Cohesion: 0.07
Nodes (49): InvoiceDetailPage(), metadata, STATUS_BADGE, Props, WaToast(), POST(), GET(), register() (+41 more)

### Community 34 - "Module Group 34"
Cohesion: 0.17
Nodes (14): createExpenseAction(), ExpenseSchema, createJournalEntryAction(), JournalSchema, LineSchema, AccountBalance, AccountCode, getAccountIds() (+6 more)
...
Cohesion: 0.15
Nodes (10): metadata, CustomerDuesReportPage(), DueRow, metadata, BADGE, PurchaseDetailPage(), InvoiceDiscountInput, InvoiceTotals (+2 more)
...
Cohesion: 0.15
Nodes (7): metadata, Account, INIT, JournalLine, EXAMPLES, RULES, NewJournalEntryPage()
...
Cohesion: 0.10
Nodes (20): updateInvoiceAction(), InvoiceBuilder(), calcInvoiceTotals(), calcLine(), round2(), CustomerOpt, InvoiceItem, Props (+12 more)
...
Cohesion: 0.33
Nodes (3): metadata, Props, ItemDetailPage()
...
Cohesion: 0.16
Nodes (15): metadata, STATUS_BADGE, STATUS_LABEL, PageProps, TailorProfilePage(), COLUMNS, metadata, NEXT_LABEL (+7 more)

### Community 47 - "Module Group 47"
Cohesion: 0.17
Nodes (11): SettingsPage(), Props, saveLowStockThresholdAction(), saveReminderConfigAction(), saveWhatsAppSettingsAction(), SettingsSaveResult, togglePurchaseOrdersAction(), toggleStaffModuleAction() (+3 more)
...
Cohesion: 0.12
Nodes (15): EditUserPage(), Props, NAV_SECTIONS, SAConsoleLayout(), UserRow, Warehouse, getSASecret(), getSASession() (+7 more)
...
Cohesion: 0.10
Nodes (14): CustomerSchema, CustomerState, Props, EditCustomerPage(), NewCustomerPage(), createSACustomerAction(), hardDeleteCustomerAction(), restoreSACustomerAction() (+6 more)
...
Cohesion: 0.13
Nodes (6): CustomerBody(), fmtMoney(), GroupedTailoringPdfInput, S, TailoringLineItem, TailoringPdfInput
...
Cohesion: 0.13
Nodes (14): InvoiceDetailPage(), STATUS_BADGE, InvoicesPage(), STATUS_BADGE, fmtDate(), fmtMoney(), InvoiceDetail, InvoiceItem (+6 more)

### Community 58 - "Module Group 58"
Cohesion: 0.12
Nodes (8): PurchaseSchema, PurchasesPage(), createSAPurchaseAction(), deleteSAPurchaseAction(), PurchaseState, DeletePurchaseButton(), PurchaseRow, STATUS_BADGE
...
Cohesion: 0.15
Nodes (22): GET(), GET(), GET(), GET(), GET(), fmtDate(), verifySession(), fmt() (+14 more)

### Community 64 - "Module Group 64"
Cohesion: 0.25
Nodes (8): PurchaseSchema, metadata, NewPurchasePage(), postPurchaseInvoice(), generateStickersForPurchase(), makePrefix(), createPurchaseInvoiceAction(), LineSchema

### Community 77 - "Community 77"
Cohesion: 0.26
Nodes (12): execAsync, getGitHash(), getInitialDataAction(), getUpdateStatusAction(), InitialData, rollbackUpdateAction(), runUpdate(), startUpdateAction() (+4 more)
...
Cohesion: 0.36
Nodes (8): advanceStatusAction(), batchFirstOrder(), CreateOrderInput, isBatchFullyAt(), markDeliveredOnCreditAction(), markDeliveredPaidAction(), NEXT_ALLOWED, sendStatusWhatsApp()
...
Cohesion: 0.14
Nodes (9): OrderRow, TailorRow, deleteSATailoringAction(), EditOrderSchema, TailoringState, updateSATailoringAction(), OrderRow, STAGE_BADGE (+1 more)

### Community 82 - "Community 82"
Cohesion: 0.15
Nodes (8): stockAdjustAction(), StockAdjustSchema, StockAdjustState, Item, Warehouse, Item, StockAdjustPage(), Warehouse

### Community 83 - "Community 83"
Cohesion: 0.22
Nodes (12): cancelInvoiceAction(), CustomerSchema, CustomerState, createCustomerAction(), parseCustomerForm(), quickCreateCustomerAction(), restoreCustomerAction(), softDeleteCustomerAction() (+4 more)

### Community 84 - "Community 84"
Cohesion: 0.18
Nodes (8): SettingsPage(), saveSASettingsAction(), SettingsState, Setting, groupSettings(), PREFIXES, Setting, SettingsForm()
...
Cohesion: 0.15
Nodes (12): CustomerDetailPage(), metadata, UserRow, UsersPage(), ConfirmForm(), Props, deleteCustomerAction(), CustomersPage() (+4 more)
...
Cohesion: 0.27
Nodes (14): GET(), fmtDate(), generateBatchTailoringPdf(), generateCreditNotePdf(), generateDebitNotePdf(), generateInvoicePdf(), generateTailoringCustomerPdf(), generateTailoringTailorPdf() (+6 more)
...
Cohesion: 0.29
Nodes (5): RootPage(), ROLE_HOME, LoginPage(), metadata, Props
...
Cohesion: 0.25
Nodes (5): EditInvoicePage(), Props, EditInvoiceForm(), InvoiceEditData, InvoiceEditData

### Community 95 - "Community 95"
Cohesion: 0.36
Nodes (4): changePasswordAction(), ChangePasswordState, ChangePasswordForm(), ChangePasswordPage()

### Community 96 - "Community 96"
Cohesion: 0.48
Nodes (6): ItemSchema, ItemState, createItemAction(), parseItem(), resolveItemType(), updateItemAction()

### Community 97 - "Community 97"
Cohesion: 0.29
Nodes (4): AlterationRow, ELIGIBLE_STATUSES, Props, requestAlterationAction()
...
Cohesion: 0.38
Nodes (6): Field, fmt(), fmtDate(), OrderDetailsPanel(), OrderDetailsPanelProps, updateOrderAction()
...
Cohesion: 0.50
Nodes (3): company, main(), measurements

## Knowledge Gaps
- **592 isolated node(s):** `metadata`, `ExpenseSchema`, `INIT`, `Category`, `metadata` (+587 more)
...
- **Why does `query()` connect `Invoice & Search API Routes` to `PDF Rendering & Document Export`, `Community 130`, `Billing Import & Debit Note Forms`, `Warehouse Settings Management`, `Tailoring Order Flow`, `Purchase Listing & Search UI`, `CRM, Designs & Reminders`, `Community 134`, `AI Import Wizards`, `Invoice Builder & Tailoring UI`, `Customer Detail & Edit Pages`, `Design Portal Actions`, `Inventory Item Management`, `Reports & Dashboard Pages`, `Supplier Management Pages`, `Module Group 21`, `Module Group 23`, `Module Group 25`, `Module Group 27`, `Module Group 28`, `Module Group 30`, `Module Group 33`, `Module Group 35`, `Module Group 36`, `Module Group 37`, `Module Group 38`, `Module Group 40`, `Module Group 43`, `Module Group 44`, `Module Group 46`, `Module Group 47`, `Module Group 49`, `Module Group 50`, `Module Group 51`, `Module Group 52`, `Module Group 53`, `Module Group 56`, `Module Group 57`, `Module Group 58`, `Module Group 59`, `Module Group 61`, `Module Group 63`, `Module Group 64`, `Module Group 65`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 86`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 98`, `Community 103`, `Community 106`, `Community 107`, `Community 109`, `Community 112`, `Community 114`, `Community 116`, `Community 119`, `Community 122`?**
  _High betweenness centrality (0.238) - this node is a cross-community bridge._
- **Why does `requireRole()` connect `CRM, Designs & Reminders` to `Community 128`, `Community 129`, `Community 130`, `Billing Import & Debit Note Forms`, `Warehouse Settings Management`, `Community 133`, `Purchase Listing & Search UI`, `Community 131`, `Community 134`, `AI Import Wizards`, `Invoice Builder & Tailoring UI`, `Customer Detail & Edit Pages`, `Expense Tracking & Forms`, `Design Portal Actions`, `Tailoring Order Flow`, `Inventory & Supplier Import API`, `Inventory Item Management`, `Reports & Dashboard Pages`, `Supplier Management Pages`, `Module Group 21`, `Module Group 22`, `Module Group 23`, `Module Group 24`, `Module Group 25`, `Module Group 26`, `Module Group 27`, `Module Group 28`, `Module Group 30`, `Module Group 31`, `Module Group 33`, `Module Group 34`, `Module Group 36`, `Module Group 37`, `Module Group 38`, `Module Group 39`, `Module Group 40`, `Module Group 42`, `Module Group 43`, `Module Group 44`, `Module Group 45`, `Module Group 46`, `Module Group 47`, `Module Group 50`, `Module Group 51`, `Module Group 53`, `Module Group 55`, `Module Group 61`, `Module Group 64`, `Module Group 65`, `Community 79`, `Community 83`, `Community 86`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 93`, `Community 96`, `Community 97`, `Community 98`, `Community 99`, `Community 101`, `Community 103`, `Community 104`, `Community 105`, `Community 106`, `Community 107`, `Community 109`, `Community 110`, `Community 111`, `Community 113`, `Community 116`, `Community 119`?**
  _High betweenness centrality (0.202) - this node is a cross-community bridge._
- **Why does `requireSA()` connect `Module Group 35` to `Community 122`, `Community 77`, `Community 78`, `Community 80`, `Community 112`, `Community 82`, `Community 81`, `Module Group 52`, `Community 84`, `Module Group 49`, `Community 87`, `Module Group 56`, `Module Group 57`, `Module Group 58`, `Module Group 59`, `Community 114`, `Community 94`, `Community 95`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Are the 91 inferred relationships involving `requireRole()` (e.g. with `GET()` and `GET()`) actually correct?**
  _`requireRole()` has 91 INFERRED edges - model-reasoned connections that need verification._
- **Are the 90 inferred relationships involving `query()` (e.g. with `GET()` and `GET()`) actually correct?**
  _`query()` has 90 INFERRED edges - model-reasoned connections that need verification._
- **Are the 53 inferred relationships involving `requireSA()` (e.g. with `EditCustomerPage()` and `CustomerDetailPage()`) actually correct?**
  _`requireSA()` has 53 INFERRED edges - model-reasoned connections that need verification._
- **Are the 11 inferred relationships involving `formatInr()` (e.g. with `ExpensesPage()` and `InvoiceDetailPage()`) actually correct?**
  _`formatInr()` has 11 INFERRED edges - model-reasoned connections that need verification._