...
9. `sendWhatsAppTemplate()` - 25 edges
...
Cohesion: 0.33
Nodes (5): metadata, STATUS_BADGE, ConfirmForm(), QuotationDetailPage(), updateQuotationStatusAction()

### Community 4 - "Warehouse Settings Management"
Cohesion: 0.14
Nodes (13): metadata, metadata, EditWarehousePage(), NewWarehousePage(), activateWarehouseAction(), createWarehouseAction(), deleteWarehouseAction(), updateWarehouseAction() (+5 more)

### Community 5 - "Tailoring Order Flow"
Cohesion: 0.13
Nodes (10): FabricOption, Props, CustomerOption, DesignOption, Field, MeasurementVersion, Props, STEPS (+2 more)
...
Cohesion: 0.06
Nodes (30): metadata, NewInvoicePage(), metadata, NewCustomerPage(), metadata, metadata, metadata, metadata (+22 more)
...
Cohesion: 0.07
Nodes (19): GET(), S, GET(), EditInvoicePage(), metadata, metadata, NewPurchasePage(), metadata (+11 more)
...
Cohesion: 0.12
Nodes (12): DatePicker(), DatePickerProps, DAY_HEADERS, fmtDisplay(), MONTHS, todayIso(), Category, INIT (+4 more)
...
Cohesion: 0.15
Nodes (10): INIT, Props, Setting, CustomerOpt, InvoiceItem, Props, RefundLine, SearchInvoice (+2 more)
...
Cohesion: 0.31
Nodes (6): MovementState, ItemWithVariants, MOVEMENT_LABELS, Props, ItemVariant, Warehouse
...
Cohesion: 0.18
Nodes (11): metadata, STATUS_BADGE, STATUS_LABEL, DeliveryActions(), fmt(), Props, ALL_STATUSES, TailoringOrderDetailPage() (+3 more)

### Community 26 - "Module Group 26"
Cohesion: 0.15
Nodes (13): metadata, metadata, EditReminderPage(), NewReminderPage(), createReminderAction(), deleteReminderAction(), ReminderSchema, toggleReminderAction() (+5 more)

### Community 27 - "Module Group 27"
Cohesion: 0.13
Nodes (10): SchemeSchema, EditSchemePage(), metadata, metadata, NewSchemePage(), SchemesPage(), createSchemeAction(), toggleSchemeAction() (+2 more)

### Community 28 - "Module Group 28"
Cohesion: 0.10
Nodes (19): metadata, metadata, metadata, metadata, metadata, BillingPage(), metadata, CustomerDuesReportPage() (+11 more)
...
Cohesion: 0.43
Nodes (5): POST(), GET(), GreetingRunResult, runDailyGreetings(), runLowStockAlerts()
...
Cohesion: 0.13
Nodes (30): cancelInvoiceAction(), register(), createInvoiceAction(), InvoiceSchema, LineItemSchema, recordPaymentAction(), retryInvoiceWaAction(), sendInvoiceWhatsAppAction() (+22 more)
...
Cohesion: 0.29
Nodes (6): metadata, NewTailorPage(), createTailorAction(), TailorSchema, toggleTailorActiveAction(), updateTailorAction()
...
Cohesion: 0.21
Nodes (11): POST(), PurchaseSchema, currentFY(), DocType, nextInvoiceNumber(), generateStickersForPurchase(), makePrefix(), createPurchaseInvoiceAction() (+3 more)
...
Cohesion: 0.09
Nodes (25): metadata, updateInvoiceAction(), createDebitNoteAction(), DebitNoteSchema, LineSchema, calcInvoiceTotals(), calcLine(), InvoiceDiscountInput (+17 more)
...
Cohesion: 0.10
Nodes (21): metadata, STATUS_BADGE, STATUS_LABEL, PageProps, TailorProfilePage(), ColumnKey, COLUMNS, metadata (+13 more)

### Community 47 - "Module Group 47"
Cohesion: 0.18
Nodes (14): SettingsPage(), createExpenseAction(), ExpenseSchema, AuditAction, AuditEntity, logAudit(), saveLowStockThresholdAction(), saveReminderConfigAction() (+6 more)
...
Cohesion: 0.15
Nodes (4): CustomerBody(), fmtMoney(), S, TailoringPdfInput

### Community 55 - "Module Group 55"
Cohesion: 0.21
Nodes (10): CustomerSchema, CustomerState, createCustomerAction(), parseCustomerForm(), quickCreateCustomerAction(), restoreCustomerAction(), softDeleteCustomerAction(), updateCustomerAction() (+2 more)
...
Cohesion: 0.27
Nodes (9): fmt(), PaymentRow, PaymentSection(), Props, fmt(), Props, RecordPaymentButton(), recordTailoringPaymentAction() (+1 more)
...
Cohesion: 0.27
Nodes (8): handleIncoming(), markProcessed(), POST(), processMessage(), WaMessage, WaOtherMessage, WaTextMessage, WaWebhookPayload
...
Cohesion: 0.36
Nodes (9): advanceStatusAction(), batchFirstOrder(), CreateOrderInput, isBatchFullyAt(), markDeliveredOnCreditAction(), markDeliveredPaidAction(), NEXT_ALLOWED, sendDeliveredWhatsApp() (+1 more)
...
Cohesion: 0.29
Nodes (5): Color, Size, SizeColorManagerProps, StockCell, Warehouse
...
Cohesion: 0.40
Nodes (4): CustomerDetailPage(), metadata, deleteCustomerAction(), InvoiceRow
...
Cohesion: 0.17
Nodes (19): GET(), fmtDate(), generateBatchTailoringPdf(), generateCreditNotePdf(), generateDebitNotePdf(), generateTailoringCustomerPdf(), generateTailoringTailorPdf(), getCompany() (+11 more)
...
Cohesion: 0.19
Nodes (12): ItemSchema, ItemState, ItemsPage(), createItemAction(), deleteItemAction(), parseItem(), resolveItemType(), toggleItemActiveAction() (+4 more)
...
Cohesion: 0.40
Nodes (4): UserRow, UsersPage(), metadata, ROLE_BADGE

### Community 97 - "Community 97"
Cohesion: 0.20
Nodes (6): AlterationRow, ELIGIBLE_STATUSES, Props, Field, Props, requestAlterationAction()
...
Cohesion: 0.32
Nodes (7): Field, fmt(), fmtDate(), OrderDetailsPanel(), OrderDetailsPanelProps, VersionHistoryEntry, updateOrderAction()
...
Cohesion: 0.50
Nodes (3): ConfirmDialog(), ConfirmDialogProps, Props

### Community 106 - "Community 106"
Cohesion: 0.29
Nodes (5): metadata, createCreditNoteAction(), CreditNoteSchema, LineSchema, NewRefundPage()
...
Cohesion: 0.07
Nodes (21): POST(), POST(), POST(), metadata, metadata, csv(), GET(), csv() (+13 more)
...
Cohesion: 0.40
Nodes (3): ItemOpt, Props, SchemeData
...
## Knowledge Gaps
- **595 isolated node(s):** `metadata`, `ExpenseSchema`, `INIT`, `Category`, `metadata` (+590 more)
...
- **Why does `formatInr()` connect `Module Group 28` to `Community 130`, `Billing Import & Debit Note Forms`, `Purchase Listing & Search UI`, `Community 135`, `Invoice Builder & Tailoring UI`, `Expense Tracking & Forms`, `Inventory & Supplier Import API`, `Reports & Dashboard Pages`, `WhatsApp Reminders UI`, `Module Group 22`, `Module Group 25`, `Module Group 33`, `Module Group 41`, `Module Group 42`, `Module Group 45`, `Module Group 46`, `Module Group 51`, `Module Group 55`, `Module Group 65`, `Community 86`, `Community 89`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Are the 92 inferred relationships involving `requireRole()` (e.g. with `GET()` and `GET()`) actually correct?**
  _`requireRole()` has 92 INFERRED edges - model-reasoned connections that need verification._
